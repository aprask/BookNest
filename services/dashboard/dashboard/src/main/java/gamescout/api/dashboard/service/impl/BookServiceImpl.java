package gamescout.api.dashboard.service.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import gamescout.api.dashboard.exceptions.MissingBookException;
import gamescout.api.dashboard.model.Book;
import gamescout.api.dashboard.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book updateBook(UUID id, String message) {
        if (id == null) {
